...
namespace td_variable_fieldsUnitTests\Admin;
...
class SettingsPageTest extends TestCase {
	...
	public function testEnqueueStyles(): void {
		...
		$settings->enqueue_styles( 'td-variable-fields' );
	}
	...
	public function testEnqueueScripts(): void {
		...
		$settings->enqueue_scripts( 'td-variable-fields' );
	}
	...
	public function testPageOption(): void {
		$pageTitle = 'TD Variable-Fields Settings';
		$settings  = new SettingsPage();
